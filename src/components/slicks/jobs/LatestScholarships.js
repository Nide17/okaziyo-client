...
const LatestScholarships = ({ allActiveScholarships }) => {
    ...
    return (
        ...
        allActiveScholarships.isLoading ? null :
            ...
            <div className="similar-jobs mt-4 mt-lg-2">
                ...
                {allActiveScholarships && allActiveScholarships.allActiveScholarships.sort(() => 0.5 - Math.random()).slice(0, 7).map((scholarship) => (
                    ...
                    <Media key={scholarship._id} className="mt-1 mt-lg-2 p-3 border-bottom job-title d-flex flex-column flex-lg-row">
