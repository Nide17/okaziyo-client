...
import { getSubCategoryScholarships } from '../../redux/items/scholarships/scholarships.actions'
import ItemsPagination from '../items/ItemsPagination'

const ScholarshipsBySubCategory = ({ categories, scholarships, getSubCategoryScholarships }) => {
    ...
    // Lifecycle methods
    useEffect(() => {
        getSubCategoryScholarships(subCategoryId, pageNo);
        setNumberOfPages(scholarships.totalPages);
    }, [getSubCategoryScholarships, pageNo, scholarships.totalPages, subCategoryId]);
        ...
        <section className="container things all">
            ...
            {scholarships.isLoading ?
                ...
                <div className="row contents mb-5 mx-1 mx-lg-3">
                    ...
                    {scholarships && scholarships.subCatScholarships.length > 0 ?
                        <>
                            <h4 className="col-12 mb-4">Scholarships that should interest you from this sub-category</h4>

                            <div className="cards by-category">
                                {scholarships && scholarships.subCatScholarships.map(scholarship => {
                                            ...
                                            <Card>
                                                ...
                                                <CardBody>
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        <a href={`/slickScholarship/${scholarship.slug}`} className="slickItem-button card-link btn btn-success">View more</a>
                        ...
                        <Alert color="danger" className="w-100">
                            No scholarships available in this sub-category
                        </Alert>}
...
export default connect(mapStateToProps, { getSubCategoryScholarships })(ScholarshipsBySubCategory);