...
import { getCategoryJobs } from '../../redux/items/jobs/jobs.actions'
import ItemsPagination from '../items/ItemsPagination'

const JobsByCategory = ({ categories, jobs, getCategoryJobs }) => {
    ...
    // Lifecycle methods
    useEffect(() => {
        getCategoryJobs(categoryId, pageNo);
        setNumberOfPages(jobs.totalCatPages);
    }, [getCategoryJobs, pageNo, jobs.totalCatPages, categoryId]);
...
export default connect(mapStateToProps, { getCategoryJobs })(JobsByCategory);